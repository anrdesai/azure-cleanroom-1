...
class VaultsOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.VaultListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-07-01")  # type: str
    ...
    def list_deleted(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeletedVaultListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.DeletedVaultListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-07-01")  # type: str
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param top: Maximum number of results to return.
        :type top: int
        :keyword filter: The filter to apply on the operation. The default value is "resourceType eq
         'Microsoft.KeyVault/vaults'". Note that overriding this default value may result in unsupported
         behavior.
        :paramtype filter: str
        :keyword api_version: Azure Resource Manager Api Version. The default value is "2015-11-01".
         Note that overriding this default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ResourceListResult or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.ResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
