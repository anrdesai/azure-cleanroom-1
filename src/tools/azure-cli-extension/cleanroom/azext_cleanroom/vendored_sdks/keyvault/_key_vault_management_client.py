...
class KeyVaultManagementClient(object):    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2023-07-01". Note that overriding this
