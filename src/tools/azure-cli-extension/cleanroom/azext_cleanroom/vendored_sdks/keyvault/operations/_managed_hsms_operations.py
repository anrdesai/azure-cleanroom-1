...
class ManagedHsmsOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ManagedHsmListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsmListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-07-01")  # type: str
    ...
    def list_deleted(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either DeletedManagedHsmListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.DeletedManagedHsmListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-07-01")  # type: str
    ...
    def check_mhsm_name_availability(
        self,
        mhsm_name,  # type: "_models.CheckMhsmNameAvailabilityParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CheckMhsmNameAvailabilityResult"
