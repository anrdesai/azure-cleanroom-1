...
def build_list_by_resource_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/regions")  # pylint: disable=line-too-long
...
class MHSMRegionsOperations(object):
    ...
    def list_by_resource(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either MHSMRegionsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.MHSMRegionsListResult]
