...
class VaultsOperations(object):
    ...
    def list_deleted(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either DeletedVaultListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.DeletedVaultListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-07-01")  # type: str
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.ResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        filter = kwargs.pop('filter', "resourceType eq 'Microsoft.KeyVault/vaults'")  # type: str
        api_version = kwargs.pop('api_version', "2015-11-01")  # type: str
