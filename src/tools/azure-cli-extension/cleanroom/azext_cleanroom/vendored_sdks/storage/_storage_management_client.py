...
class StorageManagementClient(object):    # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        self.storage_task_assignments = StorageTaskAssignmentsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.storage_task_assignments_instances_report = StorageTaskAssignmentsInstancesReportOperations(self._client, self._config, self._serialize, self._deserialize)
        self.storage_task_assignment_instances_report = StorageTaskAssignmentInstancesReportOperations(self._client, self._config, self._serialize, self._deserialize)
