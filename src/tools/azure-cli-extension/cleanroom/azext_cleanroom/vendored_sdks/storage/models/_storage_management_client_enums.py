...
class AllowedMethods(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class LeaseContainerRequestEnum(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ListEncryptionScopesInclude(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    ALL = "All"
    ENABLED = "Enabled"
    DISABLED = "Disabled"

class ListLocalUserIncludeParam(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class MigrationName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostFailoverRedundancy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PostPlannedFailoverRedundancy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RunResult(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RunStatusEnum(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
