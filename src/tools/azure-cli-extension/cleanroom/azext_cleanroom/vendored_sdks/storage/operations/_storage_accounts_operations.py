...
def build_get_properties_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.StorageAccountExpand"]]
...
def build_list_keys_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    expand = kwargs.pop('expand', "kerb")  # type: Optional[str]
...
def build_failover_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    failover_type = kwargs.pop('failover_type', "Planned")  # type: Optional[str]
    ...
    if failover_type is not None:
        _query_parameters['failoverType'] = _SERIALIZER.query("failover_type", failover_type, 'str')
...
def build_hierarchical_namespace_migration_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    request_type = kwargs.pop('request_type')  # type: str
...
def build_customer_initiated_migration_request_initial(
    resource_group_name,  # type: str
    account_name,  # type: str
    subscription_id,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/startAccountMigration")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=24, min_length=3, pattern=r'^[a-z0-9]+$'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_get_customer_initiated_migration_request(
    resource_group_name,  # type: str
    account_name,  # type: str
    migration_name,  # type: Union[str, "_models.MigrationName"]
    subscription_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/accountMigrations/{migrationName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=24, min_length=3, pattern=r'^[a-z0-9]+$'),
...
class StorageAccountsOperations(object):  # pylint: disable=too-many-public-methods
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2023_05_01.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    ...
    def _failover_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        failover_type="Planned",  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def begin_failover(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs  # type: Any
        ...
        :param failover_type: The parameter is set to 'Planned' to indicate whether a Planned failover
         is requested. The default value is "Planned".
    ...
    def _customer_initiated_migration_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters,  # type: "_models.StorageAccountMigration"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        request = build_customer_initiated_migration_request_initial(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    _customer_initiated_migration_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/startAccountMigration"}  # type: ignore


    @distributed_trace
    def begin_customer_initiated_migration(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters,  # type: "_models.StorageAccountMigration"
    ...
    begin_customer_initiated_migration.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/startAccountMigration"}  # type: ignore
    ...
    def get_customer_initiated_migration(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.StorageAccountMigration"
    ...
    get_customer_initiated_migration.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/accountMigrations/{migrationName}"}  # type: ignore
