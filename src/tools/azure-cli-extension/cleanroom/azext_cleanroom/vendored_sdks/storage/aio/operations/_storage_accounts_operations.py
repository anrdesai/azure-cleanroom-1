...
class StorageAccountsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2023_05_01.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2023_05_01.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
    ...
    async def _failover_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        account_name: str,
        failover_type: Optional[str] = "Planned",
        **kwargs: Any
    ) -> None:
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        error_map = {
    ...
    @distributed_trace_async
    async def begin_customer_initiated_migration(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        parameters: "_models.StorageAccountMigration",
    ...
    async def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either BlobRestoreStatus or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2023_05_01.models.BlobRestoreStatus]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2023-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
