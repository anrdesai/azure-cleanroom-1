...
class BlobServicesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2023_05_01.models.BlobServiceItems]
    ...
    async def set_service_properties(
        ...
        **kwargs: Any
        ...
        :keyword blob_services_name: The name of the blob Service within the specified storage account.
         Blob Service Name must be 'default'. The default value is "default". Note that overriding this
