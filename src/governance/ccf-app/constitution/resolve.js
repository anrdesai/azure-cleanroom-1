...
function isCgsOperator(memberId) {
  ...
  return (
    info.member_data &&
    info.member_data.cgs_roles &&
    info.member_data.cgs_roles.cgs_operator === "true"
  );
}
...
function isContractOperator(memberId) {
  ...
  return (
    info.member_data &&
    info.member_data.cgs_roles &&
    info.member_data.cgs_roles.contract_operator === "true"
  );
}
...
export function resolve(proposal, proposerId, votes) {
  ...
  const acceptedMemberCount = getAcceptedMemberCount();
