...
export function getGenerateSigningKeyKid(): string {
  if (oidcIssuerGovStore.has("generateSigningKeyKid")) {
    return oidcIssuerGovStore.get("generateSigningKeyKid");
  }

  // Back-compat: above key was not set in older flows and logic used a fixed kid value.
  // TODO (gsinha): Remove this path after enough transition time.
  return "08bf5c3772dd4e7a727a101bf520f6575cac326f";
}
