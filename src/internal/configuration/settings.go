...
type PolicyEngine struct {
	// Use a default policy that allows all traffic with no request/response headers and body restriction.
...
type OtlpConfig struct {
	// Eg: otel-collector.observability.svc.cluster.local:4317
