...
public class CAciRecoveryServiceInstanceProvider : ICcfRecoveryServiceInstanceProvider
{
        ...
        JsonObject? providerConfig)
    {
        ...
        return this.ToRecoveryServiceHealth(lbContainerGroup.Data);
    }
...
#pragma warning restore MEN002 // Line is too long
    ...
    private RecoveryServiceHealth ToRecoveryServiceHealth(ContainerGroupData data)
    {
        ...
        var ep = this.ToServiceEndpoint(data);
